...
extension Clauses {
    ...
    nonisolated(unsafe)
    package static let generalTermsAndConditions2: Translated<Self> = {
    ...
    nonisolated(unsafe)
    package static let generalTermsAndConditions3: Translated<Self> = {
    ...
    nonisolated(unsafe)
    package static let generalTermsAndConditions4: Translated<Self> = {
